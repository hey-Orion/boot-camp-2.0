ok now i have writen the codes by myself and i used help where i needed even then i have writen about 50% of the code by myself.
so now review the codes. 
...
select customer_id, count(*) as total_amount
from ordars
...
from customers c 
left join ordars o on c.customer_id = o.customer_id
where o.customer_id in NULL;
